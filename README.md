...
NEXT_PUBLIC_BACKEND_URL='http://127.0.0.1:8080' NEXT_PUBLIC_INTERNAL_URL='http://127.0.0.1:8080' DATA_ROOT='/Users/phlee/Data/output' npm run dev
...
```
// npm run build
DATA_ROOT='/Users/phlee/Data/output' npm run build
